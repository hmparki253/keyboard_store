...
public class OrderedProductVO {
    ...
    public OrderedProductVO(int id, String name, String description, int price, int inventory, Date regDate, int categoryId, int discount, int quantity, String randName, int titleCk, String originName) {
        this.id = id;
        this.name = name;
